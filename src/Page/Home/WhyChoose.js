    ...
    return (
        <div className='my-10 max-w-6xl mx-auto'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 p-3'>
                <div className=' bg-neutral-200 rounded-md p-7 mt-10 shadow-md' data-aos="fade-right" data-aos-duration="1000">
                ...
                <div className=' bg-neutral-200 rounded-md p-7 mt-10 shadow-md' data-aos="fade-up" data-aos-duration="1000">
                ...
                <div className=' bg-neutral-200 rounded-md p-7 mt-10 shadow-md' data-aos="fade-down" data-aos-duration="1000">
