...
const Booking = () => {
    ...
    if (!bookingProducts.length) {
        return <div data-aos="fade-down" data-aos-duration="1000" className='h-[300px] mt-[50px] pt-10 md:h-[400px] flex justify-center items-center'><h1 className='text-center text-xl font-semibold my-10'>Your booking is empty. Please <Link to="/product"><span className='text-indigo-600'>Booking Now</span></Link></h1></div>
    }
